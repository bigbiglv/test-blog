import{u as a,o as n,c as l,d as p}from"./index.fcfeccfd.js";const c={class:"markdown-body"},t=p(`<h4 id="watch%E5%92%8Cwatcheffect-%E6%95%B0%E6%8D%AE%E7%9B%91%E5%90%AC" tabindex="-1"><a class="header-anchor" href="#watch%E5%92%8Cwatcheffect-%E6%95%B0%E6%8D%AE%E7%9B%91%E5%90%AC"><span aria-hidden="true">#</span></a> watch\u548CwatchEffect \u6570\u636E\u76D1\u542C</h4><hr><ul><li>\u5728setup()\u6216script setup\u521B\u5EFA\u7684\u4FA6\u542C\u5668\u662F\u7ED1\u5B9A\u5728\u5F53\u524D\u7EC4\u4EF6\u5B9E\u4F8B\u4E0A\u7684\uFF0C\u4F1A\u968F\u7740\u7EC4\u4EF6\u7684\u5378\u8F7D\u800C\u9500\u6BC1</li><li><strong>\u5982\u679C\u5728\u5F02\u6B65\u56DE\u8C03\u4E2D\u521B\u5EFA\u4E00\u4E2A\u4FA6\u542C\u5668\u7684\u8BDD\u662F\u4E0D\u4F1A\u968F\u7740\u7EC4\u4EF6\u7684\u5378\u8F7D\u800C\u9500\u6BC1\u7684\uFF0C\u9700\u8981\u624B\u52A8\u505C\u6B62</strong></li></ul><pre><code class="hljs language-ts"><span class="hljs-keyword">import</span> { ref,watch } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre><h4 id="watch" tabindex="-1"><a class="header-anchor" href="#watch"><span aria-hidden="true">#</span></a> watch</h4><ul><li>\u7B2C\u4E00\u4E2A\u53C2\u6570\uFF1A\u76D1\u542C\u7684\u6570\u636E\uFF0C\u53EF\u4EE5\u662F\u7BAD\u5934\u51FD\u6570\uFF0C\u6570\u7EC4\u548C\u5355\u4E2A\u53C2\u6570</li><li>\u7B2C\u4E8C\u4E2A\u53C2\u6570\uFF1A\u56DE\u8C03\u51FD\u6570</li><li>\u7B2C\u4E09\u4E2A\u53C2\u6570\uFF1A\u5C5E\u6027\u8BBE\u7F6E\xA0immediate\uFF0Cdeep</li></ul><p>ref \u5B9A\u4E49\u7684\u6570\u636E</p><ul><li>\u5206\u4E3A\u57FA\u672C\u7C7B\u578B\u548C\u5F15\u7528\u7C7B\u578B <ul><li>\u76D1\u542C\u57FA\u672C\u6570\u636E\u7C7B\u578B\u4E0D\u9700\u8981\u52A0<code>.value</code></li><li>\u76D1\u542C\u5F15\u7528\u6570\u636E\u7C7B\u578B\u9700\u8981\u52A0<code>.value</code></li></ul></li></ul><pre><code class="hljs language-js">\xA0<span class="hljs-comment">// 1.\u76D1\u542Cref\u5B9A\u4E49\u76841\u4E2A\u6570\u636E</span>
...
\xA0<span class="hljs-comment">/* \u6216\u8005\u4F7F\u7528deep */</span>
\xA0<span class="hljs-comment">//\u76D1\u542C\u5177\u4F53\u67D0\u4E2A\u5C5E\u6027\u7684\u65F6\u5019\u4F1A\u5931\u6548</span>
...
</code></pre><p>reactive\u5B9A\u4E49\u7684\u6570\u636E</p><ul><li>\u5185\u90E8\u5C5E\u6027\u503C\u662F\u57FA\u672C\u6570\u636E\u7C7B\u578B\u7684\u65F6\u5019\u4E0D\u9700\u8981deep\u5C5E\u6027\u4E5F\u80FD\u76D1\u542C\u5230\u4F46deep\u4E0D\u80FD\u624B\u52A8\u5173\u95ED</li><li>\u5185\u90E8\u5C5E\u6027\u503C\u662F\u5F15\u7528\u6570\u636E\u7C7B\u578B\u7684\u65F6\u5019\u5C31\u9700\u8981\u6DFB\u52A0deep\uFF0C\u56E0\u4E3A\u76D1\u542C\u7684\u662F\u5185\u5B58\u5730\u5740</li></ul><pre><code class="hljs language-js">\xA0<span class="hljs-comment">// 1.\u76D1\u542Creactive\u5B9A\u4E49\u7684\u6570\u636E\xA0</span>
...
\xA0<span class="hljs-comment">// 2.\u76D1\u542Creactive\u5B9A\u4E49\u7684\u6570\u636E\u7684\u67D0\u4E00\u4E2A\u5C5E\u6027 \u7BAD\u5934\u51FD\u6570</span>
...
\xA0<span class="hljs-comment">// 3.\u76D1\u542Creactive\u5B9A\u4E49\u7684\u6570\u636E\u7684\u591A\u4E2A\u5C5E\u6027 \u7BAD\u5934\u51FD\u6570\u8FD4\u56DE\u6570\u7EC4</span>
...
\xA0})
\xA0<span class="hljs-comment">// \u6216 \u6570\u7EC4\u91CC\u6BCF\u4E2A\u90FD\u7528\u7BAD\u5934\u51FD\u6570\u8FD4\u56DE</span>
...
</code></pre><hr><h4 id="watcheffect" tabindex="-1"><a class="header-anchor" href="#watcheffect"><span aria-hidden="true">#</span></a> watchEffect</h4><ul><li>watchEffect\u51FD\u6570\u4F53\u5185\u4F7F\u7528\u7684\u90A3\u4E2A\u53C2\u6570\u5C31\u76D1\u542C\u54EA\u4E2A\u53C2\u6570</li><li>\u6709\u70B9\u50CFcomputed\uFF0C\u4F46\u662Fcomputed\u66F4\u6CE8\u91CDreturn\u7684\u503C\uFF0CwatchEffect\u66F4\u6CE8\u91CD\u8FC7\u7A0B\uFF0C\u4E0D\u7528return</li></ul><pre><code class="hljs language-js"><span class="hljs-title function_">watchEffect</span>(<span class="hljs-function">()=&gt;</span>{
...
</code></pre>`,16),e=[t],d=[],f={__name:"watch\u548CwatchEffect \u6570\u636E\u76D1\u542C",setup(o,{expose:s}){return s({frontmatter:{meta:[]}}),a({meta:[]}),(j,r)=>(n(),l("div",c,e))}};export{f as default,d as meta};
